"""
Django settings for General Manager project.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': env('DJANGO_DATABASE_DEFAULT_NAME', default='general-manager'),
        'USER': env('DJANGO_DATABASE_DEFAULT_USER', default='general-manager'),
        'PASSWORD': env(
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': env('DJANGO_LOG_FILE', default='/tmp/general-manager.log'),
        },
    },
    'loggers': {
        'django.request': {
...
AWS_STORAGE_BUCKET_NAME = 'general-manager'
...
EMAIL_USE_TLS = True
SERVER_EMAIL = env('DJANGO_SERVER_EMAIL', default='no-reply@general-manager.com')

# Site settings
SITE_NAME = "General Manager"
